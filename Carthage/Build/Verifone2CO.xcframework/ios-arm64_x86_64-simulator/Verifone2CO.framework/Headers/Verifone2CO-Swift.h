...
#ifndef VERIFONE2CO_SWIFT_H
#define VERIFONE2CO_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Verifone2CO",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11Verifone2CO22BaseFormViewController")
...
SWIFT_CLASS("_TtC11Verifone2CO13BaseTextField")
...
@interface BaseTextField (SWIFT_EXTENSION(Verifone2CO))
...
- (BOOL)validateAndThrowErrorAndReturnError:(NSError * _Nullable * _Nullable)error;
@end


@protocol UITextFieldDelegate;

SWIFT_CLASS("_TtC11Verifone2CO12CVVTextField")
@interface CVVTextField : BaseTextField
...
@interface CVVTextField (SWIFT_EXTENSION(Verifone2CO)) <UITextFieldDelegate>
- (BOOL)textField:(UITextField * _Nonnull)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString * _Nonnull)string SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC11Verifone2CO27CardFormExpiryDateTextField")
@interface CardFormExpiryDateTextField : BaseTextField
...
@interface CardFormExpiryDateTextField (SWIFT_EXTENSION(Verifone2CO)) <UITextFieldDelegate>
- (BOOL)textField:(UITextField * _Nonnull)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString * _Nonnull)string SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC11Verifone2CO21CardFormNameTextField")
@interface CardFormNameTextField : BaseTextField
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (BOOL)validateAndThrowErrorAndReturnError:(NSError * _Nullable * _Nullable)error;
...
SWIFT_CLASS("_TtC11Verifone2CO23CardFormNumberTextField")
@interface CardFormNumberTextField : BaseTextField
@property (nonatomic, strong) id <UITextFieldDelegate> _Nullable delegate;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (BOOL)validateAndThrowErrorAndReturnError:(NSError * _Nullable * _Nullable)error;
...
@interface CardFormNumberTextField (SWIFT_EXTENSION(Verifone2CO)) <UITextFieldDelegate>
- (BOOL)textField:(UITextField * _Nonnull)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString * _Nonnull)string SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC11Verifone2CO22Verifone2COPaymentForm")
@interface Verifone2COPaymentForm : BaseFormViewController
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC11Verifone2CO28CreditCardFormViewController")
@interface CreditCardFormViewController : Verifone2COPaymentForm
...
SWIFT_CLASS("_TtC11Verifone2CO10DimmedView")
...
SWIFT_CLASS("_TtC11Verifone2CO10FormButton")
...
SWIFT_CLASS("_TtC11Verifone2CO28PanModalPresentationAnimator")
...
@interface PanModalPresentationAnimator (SWIFT_EXTENSION(Verifone2CO)) <UIViewControllerAnimatedTransitioning>
...
SWIFT_CLASS("_TtC11Verifone2CO30PanModalPresentationController")
...
@interface PanModalPresentationController (SWIFT_EXTENSION(Verifone2CO)) <UIGestureRecognizerDelegate>
...
///
/// \endcode
SWIFT_CLASS("_TtC11Verifone2CO28PanModalPresentationDelegate")
...
@interface PanModalPresentationDelegate (SWIFT_EXTENSION(Verifone2CO)) <UIPopoverPresentationControllerDelegate>
...
@interface PanModalPresentationDelegate (SWIFT_EXTENSION(Verifone2CO)) <UIViewControllerTransitioningDelegate>
...
SWIFT_CLASS("_TtC11Verifone2CO24PaymentAuthorizingResult")
@interface PaymentAuthorizingResult : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC11Verifone2CO31VF2COAuthorizePaymentController")
@interface VF2COAuthorizePaymentController : Verifone2COPaymentForm
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil SWIFT_UNAVAILABLE;
@end
...
@interface VF2COAuthorizePaymentController (SWIFT_EXTENSION(Verifone2CO)) <WKNavigationDelegate, WKUIDelegate>
