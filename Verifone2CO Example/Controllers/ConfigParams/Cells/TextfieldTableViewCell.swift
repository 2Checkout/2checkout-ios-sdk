...
class TextFieldTableViewCell: UITableViewCell, UITextFieldDelegate {
    ...
    var textfield: BaseTextField! = {
        ...
        t.borderStyle = .none
        t.textColor = UIColor.VF2Co.cardFormTextfieldText
        t.translatesAutoresizingMaskIntoConstraints = false
        t.layer.cornerRadius = 6.0
        return t
    }()
    ...
    private func configureViews() {
        ...
        hStack.topAnchor.constraint(equalTo: contentView.topAnchor, constant: 0.0).isActive = true
        hStack.bottomAnchor.constraint(equalTo: contentView.bottomAnchor, constant: 0.0).isActive = true
